	...
	<div class="row">
        <div class="col-lg-4 col-xs-4"> 
			...
			<div class="small-box bg-red">
				<div class="inner">
					<h3><?php echo number_format(305.64, 2); ?> M</h3>
					<p>Target</p>
				</div>
				<div class="icon">
		...
		<div class="col-lg-4 col-xs-4">
			<div class="col-lg-12 col-xs-12">
				...
				<div class="small-box bg-green">
					<div class="inner">
						<h3><?php echo number_format(43.96, 2); ?> M</h3>
						<p>Target Mei</p>
					</div>
					<div class="icon">
		...
		<div class="col-lg-4 col-xs-4">
			<div class="col-lg-12 col-xs-12">
				...
				<div class="small-box bg-yellow">
					<div class="inner">
						<h3><?php echo number_format(33.54, 2); ?> M</h3>
						<p>Realisasi</p>
					</div>
					<div class="icon">
			...
			<div class="col-lg-12 col-xs-12">
				...
				<div class="small-box bg-yellow">
					<div class="inner">
						<h3>76.3<sup style="font-size: 20px">%</sup></h3>
						<p>Realisasi</p>
					</div>
					<div class="icon">
